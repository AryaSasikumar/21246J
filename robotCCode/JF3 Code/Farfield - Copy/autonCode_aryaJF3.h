...
{
	clearTimer(T2);
	while(SensorValue[mogoPot] >= potValue && time1[T2] < 1500)
	{
		motor[mobile] = -speed;
	}
	motor[mobile] = 0;//change to hold if needed
...
void autonRun(int autonNum)
{
	...
	else if(autonNum == 1)//---Blue_RIGHT_20_POINT---//
	{
		motor[elevator] = 15;
		liftUp(1525, -127, 25, 30, 3000);
		clawClose(1650, -127, -30);//(potValue, speed, hold)
		//wait1Msec(10);
		//vbUp(350, 127, 10);
		...
		liftDown(1575, 75, 10, 170, 3000);
		wait1Msec(100);
		clawOpen(600, -127, 0);//(potValue, speed, hold)
		//vbDown(2350, 127, 10);
		//fwds(350, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)
		//clawClose(3100, -127, -30);//(potValue, speed, hold)
		bwds(1100, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)

		turnLeftEncoder(520, -127, 0, 100);//(distance, speed, brake, wait)
		fwds(200, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)
		turnLeftEncoder(200, -127, 0, 100);//(distance, speed, brake, wait)
		fwds(500, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)
		liftUp(1100, -127, 15, 30, 3000);
		mogoOut(1900, -127, 0);//(potValue, speed, hold)
	...
	else if(autonNum == 2)//---RED_LEFT_10_POINT---//
	{
		...
		turnRightEncoder(720, -127, 0, 100);//(distance, speed, brake, wait)
		fwds(100, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)
		turnRightEncoder(170, -127, 0, 100);//(distance, speed, brake, wait)
		fwds(100, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)
		liftUp(1100, -127, 15, 30, 3000);
	...
	else if(autonNum == 3)//---Blue_Left_20_Point---//
	{
		...
		turnRightEncoder(550, -127, 0, 100);//(distance, speed, brake, wait)
	...
	else if(autonNum == 4)//---BLUE_RIGHT_10_POINT---//
	{
		...
		motor[elevator] = 30;
		mogoOut(2390, -127, 0);//(potValue, speed, hold)
		fwds(1400, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)
		mogoIn(200, -110, 0);//(potValue, speed, hold)
		liftDown(1575, 75, 10, 200, 3000);
		clawOpen(2575, -127, 0);//(potValue, speed, hold)
		wait1Msec(75);
		vbDown(2350, 127, 10);
		fwds(500, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)
		...
		mogoIn(180, -127, 0);//(potValue, speed, hold)
		liftDown(1575, 75, 10, 170, 3000);
		clawOpen(530, -127, 0);//(potValue, speed, hold)
		wait1Msec(75);
		vbDown(2350, 127, 10);
		fwds(350, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)
		clawClose(1650, -127, -30);//(potValue, speed, hold)
		...
		//wait1Msec(10);
		wait1Msec(100);
		clawOpen(520, -127, -15);//(potValue, speed, hold)
		wait1Msec(75);


		turnLeftEncoder(720, -127, 0, 100);//(distance, speed, brake, wait)
		fwds(150, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)
	...
	else if(autonNum ==8) //---RED_RIGHT_20_POINT---//
	{
		...
		while(g!=2)
		{
			if(SensorValue[liftPot] <= 1300 || time1[T2] >= 3000)
			{
				liftControl(30);
				if(disable1 == false)
				{
		...
		wait1Msec(75);
		//bwds(1450, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)
		turnLeftEncoder(550, -127, 0, 100);//(distance, speed, brake, wait)
		fwds(650, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)
	...
	else if(autonNum == 9)//-- RedLeftt20---//
	{
		...
		turnRightEncoder(520, -127, 0, 100);//(distance, speed, brake, wait)
		fwds(200, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)
		turnRightEncoder(350, -127, 0, 100);//(distance, speed, brake, wait)
		fwds(500, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)
		liftUp(1100, -127, 15, 30, 3000);
		mogoOut(1900, -127, 0);//(potValue, speed, hold)
		bwds(100, 127, 10, 50, 3000);//(distance, speed, brake, wait, timer)

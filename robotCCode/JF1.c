...
#pragma config(Sensor, dgtl3,  ball,           sensorQuadEncoder)
...
void fwds(int distance, int speed, int brake, int wait, int timer)
{
	clearTimer(T2);
	clearEncoders();
	while(abs(SensorValue[driveEncoder]) < distance && time1[T2] < timer)
	{
		base(speed,speed);
	}
	if(brake != 0)
...
{
	//RIGHT
	while(abs(SensorValue[driveEncoder]) <= distance)
	{
		base((-speed),(speed));
	}
	if(brake != 0)
...
void intake(int distance, int speed, int brake, int wait, int timer)
{
	clearTimer(T2);
	clearEncoders();
	while(abs(SensorValue[ball]) < distance && time1[T2] < timer)
	{
...
void outtake(int distance, int speed, int brake, int wait, int timer)
{
	intake(distance, -speed, brake, wait, timer);
}
...
task autonomous()
{
	...
	/*tor[rightShot] = 127;
	motor[leftShot] = 127;
	fwds( 1500, 127, 10, 500, 3000);
	intake( 200, 127, 5, 500, 3000);
	bwds( 1000, 127, 10, 500, 3000);*/
	turnLeft( 500, 127, 10, 3000);
	/*ake( 200, 127, 5, 1000, 3000);//supposted to shoot
	fwds( 500, 127, 10, 500, 3000);
	intake( 200, 127, 5, 1000, 3000);//supposted to shoot
	bwds( 1500, 127, 10, 500, 3000);
	turnLeft( 500, 127, 10, 3000);
	fwds( 2000, 127, 10, 500, 3000);*/
}

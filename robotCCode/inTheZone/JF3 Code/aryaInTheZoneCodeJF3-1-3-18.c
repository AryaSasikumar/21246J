...
void liftUserControl(int speed, int hold)
{
	...
	else if(vexRT[Btn7R] == 1)
	{
		...
		clearTimer(T3);
		while(SensorValue[towerPing] <= 20 && SensorValue[liftPot] >= 5 && time1[T3] < 5000)
		{
			liftControl(110);
		}
		...
		liftControl(hold);
		clearTimer(T3);
		while(SensorValue[vbPot] >= 400 && time1[T3] < 2000)
		{
			motor[elevator] = 127;
		}
		motor[elevator] = 15;
		wait1Msec(250);
		clearTimer(T3);
		while(SensorValue[liftPot] <= (liftVal+150) && time1[T3] < 2000)
		{
			liftControl(-50);
		}
		liftControl(hold);
		...
		wait1Msec(250);
		clearTimer(T3);
		while(SensorValue[liftPot] >= (liftVal-200) && time1[T3] < 2000)
		{
			liftControl(110);
		}
		liftControl(hold);
		wait1Msec(250);
		clearTimer(T3);
		while(SensorValue[vbPot] <= 1400 && time1[T3] < 2000)
		{
			motor[elevator] = -127;
		}
		motor[elevator] = 15;
		wait1Msec(50);
		clearTimer(T3);
		while(SensorValue[liftPot] <= 1350 && time1[T3] < 2000)
		{
			liftControl(-50);
		}
		liftControl(hold);
...
void autonRun()
{
	...
	else if(autonNum == 3)//---Blue_Left_20_Point---//
	{
		...
		turnRight(1250, 127, 0, 100);//(distance, speed, brake, wait)
		fwds(600, 127, 10, 0, 3000);//(distance, speed, brake, wait, timer)
		turnRight(750, 127, 0, 100);//(distance, speed, brake, wait)

...
#pragma config(Motor,  port2,           mobileRight,   tmotorVex393_MC29, openLoop, reversed)
...
void mogoIn()
{
	while(SensorValue[mogoPot] != 1410)
	{
		motor[mobileLeft] = 127;
		motor[mobileRight] = 127;
	}
...
void openClaw()
{
	while(SensorValue[clawPot] != 2375)
	{
		motor[intake] = -127;
	}
}

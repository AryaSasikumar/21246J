...
// #include "Robot/AI/AI_Robot_Link.h"
...
// AI::Robot_Link::~Robot_Link(){}

// //Get the total number of good received packets
// int32_t AI::Robot_Link::get_packets(){ return packets; }

// int32_t
// AI::Robot_Link::get_errors() {
//     return errors;
...
// /*---------------------------------------------------------------------------*/
// void
// AI::Robot_Link::set_remote_location( float x, float y, float heading ) {
//     txlock.lock();
...
// /*---------------------------------------------------------------------------*/
// void
// AI::Robot_Link::get_local_location( float &x, float &y, float &heading ) {
//     txlock.lock();
...
// /*---------------------------------------------------------------------------*/
// void
// AI::Robot_Link::get_remote_location( float &x, float &y, float &heading ) {
//     rxlock.lock();
...
// /*---------------------------------------------------------------------------*/
// bool
// AI::Robot_Link::process( uint8_t data ) {
...
// /*---------------------------------------------------------------------------*/
// int
// AI::Robot_Link::rx_task( void *arg  ) {
//     uint8_t buffer[128];
...
// /*---------------------------------------------------------------------------*/
// int
// AI::Robot_Link::tx_task( void *arg ) {
//     if( arg == NULL)
//       return(0);
...
//       vex::this_thread::sleep_for( 1000/loops_sec );
//     }
// }

...
// // 
// int32_t AI::Jetson::get_data( MAP_RECORD *map ) {
//     int32_t length = 0;
...
// /*---------------------------------------------------------------------------*/
// bool AI::Jetson::parse( uint8_t data ) {
//     bool  bRecall = false;
